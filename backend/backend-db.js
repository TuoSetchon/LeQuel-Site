...
async function migrate() {
  ...
  await pool.query(`
    ALTER TABLE lequel_accounts ADD COLUMN IF NOT EXISTS reset_token TEXT;
    ALTER TABLE lequel_accounts ADD COLUMN IF NOT EXISTS reset_token_expires TIMESTAMPTZ;
  `);
